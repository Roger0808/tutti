...
func TestParseEventStreamClientPublishFrameRejectsUnknownPayloadFields(t *testing.T) {
	...
	payload := validPublishFrameJSON(t, `{
		...
		"emittedAt":"`+time.Now().UTC().Format(time.RFC3339Nano)+`",
		"payload":{
			"preferences":{"agentComposerDefaultsByProvider":{},"agentGuiConversationRailCollapsedByProvider":{},"agentWorkMode":"coding","defaultAgentProvider":"codex","dockIconStyle":"default","locale":"en",
				"themeSource":"system",
