...
const requiredFiles = [
  ...
  "public/assets/agent-gui-unconnected.png",
  ...
  "public/assets/apps-example-prototype.png",
  "public/assets/apps-example-docs.png",
  ...
  "public/assets/icon-window-layout.png",
