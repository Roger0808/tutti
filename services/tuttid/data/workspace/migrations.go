...
const schemaMigrationDesktopPreferencesAgentWorkModeV1 = "desktop_preferences_agent_work_mode_v1"
...
`, schemaMigrationWorkspacesV1, unixMs(time.Now().UTC()))
	...
	if err := s.applyDesktopPreferencesAgentWorkModeV1(ctx); err != nil {
		return err
	}
