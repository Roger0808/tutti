...
CREATE TABLE IF NOT EXISTS nextopd_schema_migrations (
  id TEXT PRIMARY KEY,
...
INSERT OR IGNORE INTO nextopd_schema_migrations (id, applied_at_unix_ms)
  VALUES (?, ?);
...
SELECT 1
FROM nextopd_schema_migrations
WHERE id = ?
`, migrationID)
