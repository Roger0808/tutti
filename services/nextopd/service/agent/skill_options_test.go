...
---
`)
	writeSkill(t, filepath.Join(codexHome, "skills", "nextop-cli", "SKILL.md"), `---
description: Internal Nextop CLI.
---
`)
...
---
`)
	writeSkill(t, filepath.Join(pluginDir, "skills", "nextop-cli", "SKILL.md"), `---
description: Internal Nextop CLI.
---
`)

	options := discoverComposerSkillOptions("claude-code", cwd, []string{
		"NEXTOP_CLAUDE_PLUGIN_DIR=" + pluginDir,
	})
