...
func TestDaemonAPIGeneratedRoutesWorkspaceTerminalsReturnServiceUnavailable(t *testing.T) {
	...
	assertGeneratedRouteError(
		t,
		recorder,
		nextopgenerated.ServiceUnavailable,
...
func TestDaemonAPIGeneratedRoutesListAgentSessionsRejectsLimitAboveContractMaximum(t *testing.T) {
	...
	assertGeneratedRouteError(
		t,
		recorder,
		nextopgenerated.InvalidRequest,
...
func TestDaemonAPIGeneratedRoutesReadAgentSessionAttachment(t *testing.T) {
	...
	var response nextopgenerated.WorkspaceAgentSessionAttachmentResponse
	decodeGeneratedRouteResponse(t, recorder, &response)
	if response.AttachmentId != "attachment-1" {
		t.Fatalf("attachmentId = %q, want attachment-1", response.AttachmentId)
	}
	if response.MimeType != nextopgenerated.WorkspaceAgentSessionAttachmentResponseMimeTypeImagepng {
...
func TestDaemonAPIGeneratedRoutesCreateAgentSession(t *testing.T) {
	...
	var response nextopgenerated.WorkspaceAgentSessionResponse
	decodeGeneratedRouteResponse(t, recorder, &response)
...
func TestDaemonAPIGeneratedRoutesGetAgentProviderComposerOptions(t *testing.T) {
	...
	var response nextopgenerated.AgentProviderComposerOptionsResponse
	decodeGeneratedRouteResponse(t, recorder, &response)
	if response.Provider != nextopgenerated.Codex {
	...
	if len(response.Skills) != 1 || response.Skills[0].Trigger != "$architecture-review" || response.Skills[0].SourceKind != nextopgenerated.AgentProviderSkillOptionSourceKindProject {
...
func TestDaemonAPIGeneratedRoutesDeleteAgentSession(t *testing.T) {
	...
	var response nextopgenerated.DeleteWorkspaceAgentSessionResponse
	decodeGeneratedRouteResponse(t, recorder, &response)
	if !response.Removed {
...
func TestDaemonAPIGeneratedRoutesListAgentSessionMessages(t *testing.T) {
	...
	var response nextopgenerated.WorkspaceAgentSessionMessagesResponse
...
func TestDaemonAPIGeneratedRoutesGetDesktopPreferences(t *testing.T) {
	...
	var response nextopgenerated.DesktopPreferencesStateResponse
	decodeGeneratedRouteResponse(t, recorder, &response)
	if !response.Initialized {
		t.Fatal("initialized = false, want true")
	}
	if response.Preferences.DockPlacement != nextopgenerated.Left {
		t.Fatalf("dockPlacement = %q, want %q", response.Preferences.DockPlacement, nextopgenerated.Left)
	}
	if response.Preferences.Locale != nextopgenerated.ZhCN {
		t.Fatalf("locale = %q, want %q", response.Preferences.Locale, nextopgenerated.ZhCN)
	}
	if response.Preferences.DefaultAgentProvider != nextopgenerated.ClaudeCode {
		t.Fatalf("defaultAgentProvider = %q, want %q", response.Preferences.DefaultAgentProvider, nextopgenerated.ClaudeCode)
	}
	if response.Preferences.ThemeSource != nextopgenerated.DesktopThemeSourceDark {
		t.Fatalf("themeSource = %q, want %q", response.Preferences.ThemeSource, nextopgenerated.DesktopThemeSourceDark)
	}
	if response.Preferences.SleepPreventionMode != nextopgenerated.WhileAgentRunning {
		t.Fatalf("sleepPreventionMode = %q, want %q", response.Preferences.SleepPreventionMode, nextopgenerated.WhileAgentRunning)
	}
}
...
func TestDaemonAPIGeneratedRoutesListWorkspaces(t *testing.T) {
	...
	var response nextopgenerated.ListWorkspacesResponse
	decodeGeneratedRouteResponse(t, recorder, &response)
...
func TestDaemonAPIGeneratedRoutesMapWorkspaceNotFound(t *testing.T) {
	...
	assertGeneratedRouteError(
		t,
		recorder,
		nextopgenerated.WorkspaceNotFound,
		"workspace_not_found",
...
func TestDaemonAPIGeneratedRoutesCreateWorkspaceIssueMapsDuplicateIDTo409(t *testing.T) {
	...
	assertGeneratedRouteError(
		t,
		second,
		nextopgenerated.WorkspaceIssueResourceExists,
...
func TestDaemonAPIGeneratedRoutesIssueTopicLifecycle(t *testing.T) {
	...
	var createResponse nextopgenerated.IssueManagerTopicResponse
	...
	var updateResponse nextopgenerated.IssueManagerTopicResponse
	...
	var listResponse nextopgenerated.IssueManagerTopicListResponse
	...
	var deleteResponse nextopgenerated.DeleteIssueManagerTopicResponse
...
func TestDaemonAPIGeneratedRoutesMapMissingIssueTopicTo404(t *testing.T) {
	...
	assertGeneratedRouteError(
		t,
		recorder,
		nextopgenerated.WorkspaceIssueResourceNotFound,
...
func TestDaemonAPIGeneratedRoutesUpdateWorkspaceIssueStatus(t *testing.T) {
	...
	var response nextopgenerated.IssueManagerIssueResponse
	decodeGeneratedRouteResponse(t, recorder, &response)
	if response.Issue.Status != nextopgenerated.IssueManagerStatusCompleted {
...
func TestDaemonAPIGeneratedRoutesListWorkspaceFileDirectory(t *testing.T) {
	...
	var response nextopgenerated.WorkspaceFileDirectoryResponse
	decodeGeneratedRouteResponse(t, recorder, &response)
...
func TestDaemonAPIGeneratedRoutesGetWorkspaceFileTreeSnapshot(t *testing.T) {
	...
	var response nextopgenerated.WorkspaceFileTreeSnapshotResponse
	decodeGeneratedRouteResponse(t, recorder, &response)
...
func TestDaemonAPIGeneratedRoutesCreateWorkspaceFileDirectoryMapsMissingParentTo404(t *testing.T) {
	...
	assertGeneratedRouteError(
		t,
		recorder,
		nextopgenerated.WorkspaceFileNotFound,
...
func TestDaemonAPIGeneratedRoutesReadWorkspaceFilePreview(t *testing.T) {
	...
	var response nextopgenerated.WorkspaceFilePreviewResponse
	decodeGeneratedRouteResponse(t, recorder, &response)
...
func TestDaemonAPIGeneratedRoutesWriteWorkspaceFileText(t *testing.T) {
	...
	var response nextopgenerated.WorkspaceFileEntryResponse
	decodeGeneratedRouteResponse(t, recorder, &response)
...
func TestDaemonAPIGeneratedRoutesUploadWorkspaceFiles(t *testing.T) {
	...
	var response nextopgenerated.UploadWorkspaceFilesResponse
	decodeGeneratedRouteResponse(t, recorder, &response)
...
func TestDaemonAPIGeneratedRoutesPreflightUploadWorkspaceFiles(t *testing.T) {
	...
	var response nextopgenerated.PreflightUploadWorkspaceFilesResponse
	decodeGeneratedRouteResponse(t, recorder, &response)
...
func openIssueRouteSQLiteStore(t *testing.T) *workspacedata.SQLiteStore {
	...
	dbPath := filepath.Join(t.TempDir(), "nextopd.db")
...
func assertGeneratedRouteError(
	...
	code nextopgenerated.ApiErrorDetailsCode,
	reason string,
	developerMessage string,
) {
	t.Helper()

	var response nextopgenerated.ApiErrorResponse
	decodeGeneratedRouteResponse(t, recorder, &response)
