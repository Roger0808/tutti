...
const (
	...
	AgentProviderSkillOptionSourceKindNextopInjected AgentProviderSkillOptionSourceKind = "nextop-injected"
...
func (e AgentProviderSkillOptionSourceKind) Valid() bool {
	...
	case AgentProviderSkillOptionSourceKindBundled:
		return true
	case AgentProviderSkillOptionSourceKindNextopInjected:
		return true
...
type CliCapability struct {
	...
	// Path Terminal command path segments, excluding the nextop binary name.
	Path   []string            `json:"path"`
