...
func eventStreamServiceUnavailableError() nextopgenerated.ServiceUnavailableErrorJSONResponse {
...
func (DaemonAPI) AttachEventStream(context.Context, nextopgenerated.AttachEventStreamRequestObject) (nextopgenerated.AttachEventStreamResponseObject, error) {
	return nextopgenerated.AttachEventStream503JSONResponse{
