...
func TestDaemonAPIRoutesAgentProviderStatuses(t *testing.T) {
	...
	var response nextopgenerated.AgentProviderStatusListResponse
...
func TestDaemonAPIRoutesUnsupportedAgentProviderStatus(t *testing.T) {
	...
	if status.Provider != nextopgenerated.Gemini {
		t.Fatalf("provider = %q, want gemini", status.Provider)
	}
	if status.Availability.Status != nextopgenerated.AgentProviderAvailabilityStatusUnsupported {
...
func TestDaemonAPIRoutesAgentProviderProbe(t *testing.T) {
	...
	var response nextopgenerated.AgentProviderProbeResponse
	decodeGeneratedRouteResponse(t, recorder, &response)
	if response.Status != nextopgenerated.AgentProviderProbeStatusFailed {
...
func TestDaemonAPIRoutesRunAgentProviderAction(t *testing.T) {
	...
	var response nextopgenerated.AgentProviderActionRunResponse
	decodeGeneratedRouteResponse(t, recorder, &response)
	if response.Status != nextopgenerated.AgentProviderActionRunStatusFailed {
		t.Fatalf("status = %q, want failed", response.Status)
	}
