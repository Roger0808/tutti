...
func InvalidRequest(reason string, options ...Option) *ProtocolError {
	return New(StatusInvalidRequest, nextopgenerated.InvalidRequest, reason, options...)
}
...
func MethodNotAllowed(options ...Option) *ProtocolError {
	return New(StatusMethodNotAllowed, nextopgenerated.MethodNotAllowed, ReasonMethodNotAllowed, options...)
}

func ServiceUnavailable(reason string, options ...Option) *ProtocolError {
	return New(StatusServiceUnavailable, nextopgenerated.ServiceUnavailable, reason, options...)
}
...
func WorkspaceNotFound(reason string, options ...Option) *ProtocolError {
	return New(StatusWorkspaceNotFound, nextopgenerated.WorkspaceNotFound, reason, options...)
}

func WorkspaceFileNotFound(reason string, options ...Option) *ProtocolError {
	return New(StatusWorkspaceFileNotFound, nextopgenerated.WorkspaceFileNotFound, reason, options...)
}

func WorkspaceIssueResourceNotFound(reason string, options ...Option) *ProtocolError {
	return New(StatusWorkspaceIssueNotFound, nextopgenerated.WorkspaceIssueResourceNotFound, reason, options...)
}

func WorkspaceIssueResourceExists(reason string, options ...Option) *ProtocolError {
	return New(StatusWorkspaceIssueExists, nextopgenerated.WorkspaceIssueResourceExists, reason, options...)
}

func WorkspaceTerminalNotFound(options ...Option) *ProtocolError {
	return New(StatusWorkspaceFileNotFound, nextopgenerated.WorkspaceTerminalNotFound, ReasonWorkspaceTerminalNotFound, options...)
}

func WorkspaceAppNotFound(options ...Option) *ProtocolError {
	return New(StatusWorkspaceNotFound, nextopgenerated.WorkspaceAppNotFound, ReasonWorkspaceAppNotFound, options...)
}

func WorkspaceOperationFailed(options ...Option) *ProtocolError {
	return New(StatusWorkspaceOperationFailed, nextopgenerated.WorkspaceOperationFailed, ReasonWorkspaceOperationFailed, options...)
}

func PreferencesOperationFailed(options ...Option) *ProtocolError {
	return New(StatusPreferencesOperationFailed, nextopgenerated.PreferencesOperationFailed, ReasonPreferencesOperationFailed, options...)
}
