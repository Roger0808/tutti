...
const issueManagerEn = {
  actions: {
    ...
    linkExistingExecutionDirectory: "Use existing project",
    ...
    saveTask: "Save issue",
    selectExecutionDirectory: "Select execution directory",
    pinTopic: "Pin",
  ...
  labels: {
    ...
    loadingExecutionDirectories: "Loading directories...",
...
const issueManagerZhCN = {
  actions: {
    ...
    linkExistingExecutionDirectory: "使用已有项目",
    moreActions: "更多操作",
    ...
    saveSubtask: "保存子事项",
    saveTask: "保存事项",
    selectExecutionDirectory: "选择执行目录",
    pinTopic: "置顶",
    saveTopic: "保存主题",
    unpinTopic: "取消置顶",
    uploadFiles: "上传文件",
  ...
  labels: {
    ...
    loadingExecutionDirectories: "正在加载目录...",
    noProject: "不使用项目",
    outputs: "输出产物",
    priority: "优先级",
    provider: "Provider",
