...
export type NextopdRequestOptions = Omit<
  RequestInit,
  "body" | "headers" | "method"
>;

export type NextopdTrackEvent = TrackEvent;
export type NextopdTrackEventsRequest = TrackEventsRequest;

export interface NextopdClient {
  ...
  searchWorkspaceFiles(
    ...
    requestOptions?: NextopdRequestOptions
  ...
  trackEvents(events: NextopdTrackEvent[]): Promise<void>;
...
export interface CreateNextopdClientInput {
  auth?: string;
  baseUrl?: string;
  fetch: typeof fetch;
}
