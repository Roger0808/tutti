...
import { unwrapAccepted, unwrapData } from "./nextopdClientResponse.ts";
import { createWorkspaceAppsClient } from "./workspaceAppsClient.ts";
import type {
  CreateNextopdClientInput,
  NextopdClient
} from "./nextopdClientTypes.ts";

export type {
  CreateNextopdClientInput,
  NextopdClient,
  NextopdRequestOptions,
  NextopdTrackEvent,
  NextopdTrackEventsRequest
} from "./nextopdClientTypes.ts";

const defaultBaseUrl = "http://nextopd.local";

export function createNextopdClient(
  input: CreateNextopdClientInput
): NextopdClient {
