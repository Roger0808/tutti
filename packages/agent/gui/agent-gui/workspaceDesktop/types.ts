...
import type { AgentProbeSnapshot } from "../../shared/contracts/dto";
import type { AgentSessionPermissionMode } from "../../shared/agentSessionTypes";
import type {
  TerminalNodeData,
  TemplateAppEntry,
  WorkspaceNode,
...
export interface WorkspaceDesktopProps {
  ...
  workspacePermissionMode?: AgentSessionPermissionMode;
