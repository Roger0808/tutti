...
describe("buildWorkspaceAgentSessionDetailViewModel", () => {
  ...
  it("collapses hook shadow tool calls when a canonical transcript tool call exists", () => {
    const view = buildWorkspaceAgentSessionDetailViewModel({
      activity,
      session,
      timelineItems: [
        ...
        item({
          ...
          itemType: "call.completed",
          callType: "tool",
          callId: "call_10c9638dc8694efb9cfe7a52",
          name: "Skill",
          status: "completed",
          payload: {
            toolName: "Skill",
    ...
    expect(view.turns[0]?.toolCalls).toEqual([
      expect.objectContaining({
        id: "call:call_10c9638dc8694efb9cfe7a52",
        toolName: "Skill",
        summary: "skill: init"
      })
    ]);
