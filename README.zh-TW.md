...
[下載 Tutti · Local macOS 版（Universal DMG）](https://tutti.sh/desktop/download?platform=macos&arch=universal&format=dmg)
...
| **訂閱**     | 你自己的 Claude、Codex 等訂閱<br>（目前僅支援 Claude Code、Codex；OpenClaw、Hermes 正在開發接入中） | 你自己的 Claude、Codex 等訂閱<br>（目前僅支援 Claude Code、Codex；OpenClaw、Hermes 正在開發接入中）                                                                                                                              |
