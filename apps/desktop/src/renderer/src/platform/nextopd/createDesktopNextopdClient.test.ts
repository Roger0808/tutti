...
import { createDesktopNextopdClient } from "./createDesktopNextopdClient.ts";

test("createDesktopNextopdClient forwards workspace agent session query params", async () => {
  let requestMethod = "";
  let requestPath = "";
  ...
  try {
    const client = createDesktopNextopdClient({
