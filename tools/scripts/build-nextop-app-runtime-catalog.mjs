...
const runtimeArtifactSchemaVersion = "nextop.app.runtime-platform.v2";
const runtimeCatalogSchemaVersion = "nextop.app.runtimes.v2";

export async function buildNextopAppRuntimeCatalog({
  artifactBaseUrl,
  metadataFiles,
  output
}) {
...
export async function main(argv = process.argv.slice(2)) {
  ...
  await buildNextopAppRuntimeCatalog(options);
}
